...
export default function LostDecadesPage() {
  ...
  const faqJsonLd = generateFaqPageJsonLd([
    ...
    },
    {
      ...
      answer: "1990年を100とすると、2025年の実質賃金は97.9と2.1%低下しています。バブル後の一時的な高水準（2000年107.8）の後、2012年に97.4まで落ち込み、コロナ後の回復で2024年に99.2まで戻したものの、2025年は再び1990年水準を下回りました。",
    },
    {
      question: "なぜ税収は税率引き上げで増えたのですか？",
      answer: "税収は1990年の60.1兆円から2002年に43.8兆円まで落ち込み、2025年に80.7兆円と過去最高を更新しました。この回復は消費税率の段階的引き上げ（3%→5%→8%→10%）と、アベノミクス以降の企業業績改善・株高による配当・キャピタルゲイン課税の増加によるもので、「実質的な経済成長」というより税率変更や名目値の膨張による側面が強いです。",
    },
    {
  ...
  return (
    <>
      ...
      <Section heading="実質賃金：35年で2.1%の低下">
        <p>
          1990年を基準（=100）にすると、2025年の実質賃金は97.9となっています。
          名目上は2.1%の低下ですが、この間に物価は23.7%上昇しています。
        </p>
        <DataBox
          items={[
      ...
      <Section heading="物価：デフレからの脱却が30年かかった">
        ...
        <DataBox
          items={[
            ...
            { label: "2024年",   value: "119.9", note: "コロナ後の物価高", color: "#D97706" },
            { label: "2025年",   value: "123.7", note: "35年間で +23.7%", color: "#D97706" },
          ]}
        />
        <p>
      ...
      <Section heading="税収：消費税と株高で名目だけは過去最高">
        <p>
          政府の一般会計税収は、バブル期の60.1兆円を大きく上回り過去最高を更新しています。
          ただし、これは消費税率の引き上げと株高による配当課税増加が主因です。
        </p>
        <DataBox
          items={[
        ...
        <ul className="list-disc pl-5 space-y-1 my-2">
          ...
          <li>
            <Link href="/articles/next-decade-forecast" className="underline" style={{ color: "var(--link)" }}>
              「失われた40年」になる前に ─ 2026〜2035年の日本経済展望
            </Link>
          </li>
        </ul>
      </Section>
