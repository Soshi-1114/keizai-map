...
export const metadata: Metadata = {
  ...
  description:
    "1990年の30万円は2025年の何円相当か。消費者物価指数（CPI、1990=100→123.7）を使って、過去の金額を現在価値に換算する方法を解説。月収・年収・貯金額を年代別に実質換算してみよう。",
...
export default function MoneyValueTimeComparisonPage() {
  ...
  const faqJsonLd = generateFaqPageJsonLd([
    {
      question: "1990年の30万円は2025年でいくら相当ですか？",
      answer: "消費者物価指数（CPI）で換算すると約37万円相当です。1990年のCPIを100、2025年を123.7として計算すると、30万円×1.237≒37万円となります。年収500万円なら約619万円、貯金1000万円なら約1237万円相当です。",
    },
    {
      question: "過去の金額を現在価値に換算する方法は？",
      answer: "「現在価値=過去の金額×（現在のCPI÷過去のCPI）」で計算できます。例えば2025年のCPIは123.7なので、1990年の金額を1.237倍すれば現在価値が得られます。同様に、各年のCPIを使えばどの年代の金額でも現在価値に換算可能です。",
    },
    {
      question: "近年の物価上昇は過去と比べてどれくらい速いですか？",
      answer: "2020年→2025年でCPIが112.4から123.7に急上昇し、たった5年で約10%上昇しました。これは1990〜2020年の30年間で12.4%しか上がらなかったのと比べて、近年の物価上昇速度が異常に高まっていることを示しています。",
    },
    {
  ...
  return (
    <>
      ...
      <ArticleLayout
        slug={SLUG}
        title="30年前の月収30万円は今いくら？─ 物価で換算する「お金の実質価値」"
        description="1990年の30万円は2025年の何円相当か。消費者物価指数（CPI）を使って、過去の金額を現在価値に換算する方法を解説。月収・年収・貯金額を年代別に実質換算してみよう。"
        readingTime={5}
        tags={["物価", "インフレ", "実質価値"]}
      >
        ...
        <Section heading="計算式：シンプルな比例計算">
          ...
          >
            ...
            <p style={{ color: "var(--muted)" }}>
              ...
              2025年のCPIは123.7なので、1990年の金額を1.237倍すれば現在価値が得られる。
            </p>
          </div>
          ...
          <LiveDataBox
            items={[
              ...
              { year: 2025, key: "cpi", label: "2025年 CPI" },
            ]}
          />
        </Section>
        ...
        <Section heading="月収・年収・貯金を年代別に換算">
          <p>
            実際に <strong>1990年の30万円が2025年でいくら相当</strong>になるか、計算してみよう。
            CPI 100 → 123.7 なので、約1.237倍だ。
          </p>

          <DataBox
            items={[
              { label: "月収30万円",  value: "≒ 37万円", note: "30 × 1.237",  color: "#D97706" },
              { label: "月収50万円",  value: "≒ 62万円", note: "50 × 1.237",  color: "#D97706" },
              { label: "年収500万円", value: "≒ 619万円", note: "500 × 1.237", color: "#D97706" },
              { label: "貯金1000万円", value: "≒ 1237万円", note: "1000 × 1.237", color: "#D97706" },
            ]}
          />

          <p>
            つまり、1990年に月収30万円もらっていた人は、今で言えば<strong>月収37万円相当</strong>を稼いでいたことになる。
            「父さんの30万円」は単純に「今の30万円」と比べてはいけない。
          </p>
        </Section>

        <Section heading="代表的な年代の換算表">
          <p>各年から2025年への換算倍率を一覧にした。</p>
            ...
            <table className="min-w-full text-sm">
              <thead>
                <tr style={{ backgroundColor: "var(--card)", borderBottom: "1px solid var(--border)" }}>
                  ...
                  <th className="text-left p-3 font-medium">2025年への倍率</th>
                  <th className="text-left p-3 font-medium">月10万円の換算</th>
                </tr>
              </thead>
              <tbody style={{ color: "var(--muted)" }}>
                {[
                  { y: 1990, cpi: 100.0, x: "1.24倍", v: "12.4万円" },
                  { y: 1995, cpi: 107.0, x: "1.16倍", v: "11.6万円" },
                  { y: 2000, cpi: 108.6, x: "1.14倍", v: "11.4万円" },
                  { y: 2005, cpi: 106.3, x: "1.16倍", v: "11.6万円" },
                  { y: 2010, cpi: 105.9, x: "1.17倍", v: "11.7万円" },
                  { y: 2015, cpi: 110.4, x: "1.12倍", v: "11.2万円" },
                  { y: 2020, cpi: 112.4, x: "1.10倍", v: "11.0万円" },
                  { y: 2024, cpi: 119.9, x: "1.03倍", v: "10.3万円" },
                  { y: 2025, cpi: 123.7, x: "1.00倍", v: "10.0万円" },
                ].map((r) => (
          ...
          <p>
            注目すべきは、<strong>2020年→2025年でCPIが112.4から123.7に急上昇</strong>している点だ。
            たった5年で物価が約10%上昇した。1990〜2020年の30年間でも12.4%しか上がらなかったのと比べて、近年の物価上昇速度の異常さがわかる。
          </p>
        </Section>
        ...
        <Section heading="まとめ">
          <ul className="list-disc pl-5 space-y-1 my-3 text-sm" style={{ color: "var(--text)" }}>
            ...
            <li>1990年の30万円 ≒ 2025年の37万円</li>
            <li>2020年→2025年だけで物価は約10%上昇している</li>
