...
export default function NisaVsSavingsPage() {
  const articleJsonLd = generateArticleJsonLd({
    ...
    description: "100万円を1990年から預金/投資に置いた場合の2025年実績を比較。",
    slug: SLUG,
    readingTime: 7,
    tags: ["NISA", "投資", "貯金"],
  });
  ...
  const faqJsonLd = generateFaqPageJsonLd([
    {
      ...
      answer: "1990年初頭に100万円を35年間放置した場合、銀行普通預金では約101万円（+1%）、日本国債で約123万円、日経平均で約196万円、S&P500（円建て）で約1,500万円超（+1,400%以上）、金で約800万円という結果になります。",
    },
    {
      question: "なぜ日本の預金は増えないのですか？",
      answer: "日本の銀行普通預金金利は1990年の約2.08%から、2000年代以降は0.1%以下が続き、2020年には約0.001%まで低下しました。35年間の大半が0.1%以下の金利で、この間に物価は23.7%上昇しているため、預金は実質的に約20%以上目減りしました。",
    },
    {
  ...
  return (
    <>
      ...
      <ArticleLayout
        slug={SLUG}
        title="新NISA vs 貯金 ─ データで考える「35年寝かせるならどっち」"
        description="1990年に100万円を銀行預金とS&P500それぞれに置いた場合、2025年にいくらになっているか。日本の超低金利と米国株の長期トレンドを実データで比較し、新NISA時代の選択を考える。"
        readingTime={7}
        tags={["NISA", "投資", "貯金"]}
      >
        <Section heading="100万円を35年間放置したら、どっちが勝つ？">
          <p>
            「貯金は意味がない」「投資は怖い」── どちらの主張も SNS で頻繁に目にする。
            では実際のところ、過去35年間のデータを使うとどうなるか？
          </p>
          <p>
            この記事では、1990年初頭に<strong>100万円を5つの運用先</strong>に置いて2025年末まで放置した場合の結果を比較する。
          </p>
        </Section>

        <Section heading="5つの選択肢、35年後の結果">
          <DataBox
            items={[
          ...
          />
          <p>
            <strong>S&P500（米国株インデックス）に投資していたら、100万円が約15倍以上</strong>になっていた計算。
            一方、銀行預金は35年間で1%しか増えていない。物価上昇（CPI +23.7%）を考えると、<strong>預金は実質的に約20%以上目減り</strong>している。
          </p>
        </Section>
        ...
        <Section heading="なぜ日本の預金は増えないのか">
          ...
          <DataBox
            items={[
              ...
              { label: "2025年", value: "≒0.2%",  note: "日銀追加利上げ後", color: "#D97706" },
            ]}
          />
          <p>
            35年間の大半が0.1%以下の金利だった。100万円を1年預けても、つく利息はわずか<strong>10円〜2万円程度</strong>。
            この間に物価は約24%上昇しているので、預金は実質的に大きなマイナスのリターンだった。
          </p>
        </Section>

        <Section heading="同じ35年間、米国株はなぜ伸びたか">
          <p>
            S&P500（米国の代表的株価指数）は1990年初頭の約330ポイントから、2025年末は約6,500ポイントへ。
            <strong>35年で約20倍</strong>に成長した（円建てでは円安効果も加わり約15倍以上）。
          </p>
          <div
        ...
        <Section heading="ただし「過去 = 将来」ではない">
          <p>
            ここで注意したいのは、<strong>過去35年の実績がそのまま将来35年に当てはまるとは限らない</strong>こと。
        ...
        <Section heading="まとめ：時間を味方につけられるかどうか">
          <ul className="list-disc pl-5 space-y-1 my-3 text-sm" style={{ color: "var(--text)" }}>
            <li>過去35年で100万円は預金で1万円増、S&P500では1,400万円超増</li>
            <li>日本の預金金利は35年で0.1%以下、物価上昇に負けている</li>
