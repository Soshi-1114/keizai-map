...
export default function RealTakeHomePay30YearsPage() {
  const articleJsonLd = generateArticleJsonLd({
    ...
    description: "社会保険料・消費税・物価で実質手取りは目減り。3パターンで1990年と2025年を比較。",
    slug: SLUG,
    readingTime: 7,
    tags: ["年収", "実質手取り", "社会保険料"],
  });
  ...
  const faqJsonLd = generateFaqPageJsonLd([
    {
      ...
      answer: "年収500万円の実質手取りは1990年の396万円から2025年の約288.6万円へと約27%減少しました。これは1990年の年収約364万円相当でしかなく、「年収500万円なのに余裕がない」と感じる原因がここにあります。",
    },
    {
      question: "なぜ実質手取りは目減りするのですか？",
      answer: "①社会保険料の上昇（1990年10.8%→2025年18.6%、+7.8pt）、②消費税の創設・引き上げ（0%→10%）、③物価上昇（CPI+23.7%）の3つが重なっているためです。所得から税金が引かれた後の支出にも追加で10%が課される構造的な圧迫があります。",
    },
    {
      question: "年収300万円・800万円の実質手取りはどう変化しましたか？",
      answer: "年収300万円は実質手取りが246.6万円から180.4万円へ約27%減少、年収800万円は593.6万円から429.4万円へ約28%減少しました。高年収帯でも約160万円分の購買力を失っており、3つのケースすべてで約27〜28%の目減りが共通しています。",
    },
    {
      question: "30年前と同じ生活水準を維持するには年収はいくら必要ですか？",
      answer: "30年前の年収300万円と同じ生活水準を2025年に維持するには、年収約410万円が必要になる計算です。「年収を上げる」だけでは追いつかない構造になっており、社会保険料・消費税・物価の三重苦が家計を圧迫しています。",
    },
  ]);
  ...
  return (
    <>
      ...
      <ArticleLayout
        slug={SLUG}
        title="年収500万でも、30年前の年収300万に負けている？─ 実質手取りで見る35年"
        description="名目の年収が増えても、社会保険料・消費税・物価上昇で実質手取りは目減りしている。年収300万・500万・800万の3パターンで「実質手取り」を1990年と2025年で比較する。"
        readingTime={7}
        tags={["年収", "実質手取り", "社会保険料"]}
      >
        <Section heading="名目年収は同じでも、生活は同じではない">
          <p>
            ...
            しかしこの500万円が<strong>1990年の500万円</strong>なのか<strong>2025年の500万円</strong>なのかで、実際の生活水準は大きく異なる。
          </p>
          <p>
        ...
        <Section heading="実質手取りの計算式">
          ...
          <p>
            1990年と2025年の前提条件は次のとおり。
          </p>
          <DataBox
            items={[
              { label: "1990年 社会保険料率", value: "10.8%", color: "#10B981" },
              { label: "2025年 社会保険料率", value: "18.6%", note: "+7.8pt", color: "#ef4444" },
              { label: "1990年 CPI",         value: "100.0",  color: "#D97706" },
              { label: "2025年 CPI",         value: "123.7",  note: "+23.7%", color: "#D97706" },
            ]}
          />
        </Section>

        <Section heading="ケース1：年収300万円の35年">
          <p>
          ...
          <div className="rounded-xl border overflow-hidden overflow-x-auto my-4" style={{ borderColor: "var(--border)" }}>
            <table className="min-w-full text-sm">
              ...
              <tbody style={{ color: "var(--muted)" }}>
                ...
                <tr>
                  <td className="p-3 font-medium" style={{ color: "var(--text)" }}>2025年</td>
                  <td className="p-3 text-right tabular-nums">300万</td>
                  <td className="p-3 text-right tabular-nums">21万</td>
                  <td className="p-3 text-right tabular-nums">55.8万</td>
                  <td className="p-3 text-right tabular-nums">223.2万</td>
                  <td className="p-3 text-right tabular-nums font-bold" style={{ color: "#ef4444" }}>180.4万</td>
                </tr>
              </tbody>
            </table>
          </div>
          ...
          <p>
            名目の年収が同じ300万円でも、実質手取りは<strong>246.6万円 → 180.4万円</strong>へと約27%減少している。
            つまり「30年前の年収300万円の人と同じ生活水準」を維持するには、2025年では年収約410万円が必要になる計算だ。
          </p>
        </Section>

        <Section heading="ケース2：年収500万円の35年">
          <p>
            ...
            <table className="min-w-full text-sm">
              ...
              <tbody style={{ color: "var(--muted)" }}>
                ...
                <tr>
                  ...
                  <td className="p-3 text-right tabular-nums">500万</td>
                  <td className="p-3 text-right tabular-nums">50万</td>
                  <td className="p-3 text-right tabular-nums">93万</td>
                  <td className="p-3 text-right tabular-nums">357万</td>
                  <td className="p-3 text-right tabular-nums font-bold" style={{ color: "#ef4444" }}>288.6万</td>
                </tr>
              </tbody>
            </table>
          </div>
          ...
          <p>
            年収500万円の実質手取りは<strong>396万円 → 288.6万円</strong>へと約27%減少。
            これは<strong>1990年の年収約364万円相当</strong>でしかない。
          </p>
          <p>
            つまり「2025年に年収500万円の暮らし」は、「1990年の年収364万円の暮らし」と同等という計算になる。
            「年収500万円なのに余裕がない」と感じる原因がここにある。
          </p>
        </Section>

        <Section heading="ケース3：年収800万円の35年">
          <p>所得税・住民税は約15%とする。</p>
          <div className="rounded-xl border overflow-hidden overflow-x-auto my-4" style={{ borderColor: "var(--border)" }}>
            <table className="min-w-full text-sm">
              <thead>
              ...
              <tbody style={{ color: "var(--muted)" }}>
                ...
                <tr>
                  ...
                  <td className="p-3 text-right tabular-nums">800万</td>
                  <td className="p-3 text-right tabular-nums">120万</td>
                  <td className="p-3 text-right tabular-nums">148.8万</td>
                  <td className="p-3 text-right tabular-nums">531.2万</td>
                  <td className="p-3 text-right tabular-nums font-bold" style={{ color: "#ef4444" }}>429.4万</td>
                </tr>
              </tbody>
            </table>
          </div>
          <p>
            年収800万円でも実質手取りは<strong>593.6万円 → 429.4万円</strong>へと約28%減少。
            高年収帯でも、約160万円分の購買力を失っていることになる。
          </p>
        </Section>
        ...
        <Section heading="3パターンに共通する3つの圧迫要因">
          ...
          >
            {[
              { num: "①", title: "社会保険料の上昇（+7.8pt）", desc: "1990年10.8% → 2025年18.6%。少子高齢化に伴い、現役世代の負担は今後も上昇圧力が続く。" },
              { num: "②", title: "消費税の創設・引き上げ（0%→10%）", desc: "1989年に3%導入、2019年に10%へ。所得から税金が引かれた後の支出にも追加で10%が課される。" },
              { num: "③", title: "物価上昇（+23.7%）", desc: "1990→2025で CPI は約24%上昇。2020年以降だけで10%上昇しており、近年の物価上昇速度が高まっている。" },
            ].map(({ num, title, desc }) => (
        ...
        <Section heading="まとめ：「同じ年収」では同じ暮らしは買えない">
          <ul className="list-disc pl-5 space-y-1 my-3 text-sm" style={{ color: "var(--text)" }}>
            <li>名目年収が同じでも、実質手取りは1990年比で約27〜28%減少</li>
            <li>年収500万円の暮らしは、1990年の年収約364万円相当</li>
            <li>社会保険料 +7.8pt / 消費税 +10pt / 物価 +23.7% の三重苦</li>
