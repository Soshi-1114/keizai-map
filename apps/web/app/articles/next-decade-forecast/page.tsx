  ...
  const faqJsonLd = generateFaqPageJsonLd([
    {
      ...
      answer: "社人研の中位推計では、2025年の70.6万人から2030年に約63万人（▲11%）、2035年に約58万人（▲18%）まで減少する見込みです。子どもを産む世代の人口が既に決まっているため、今後10年の出生数は概ね決定済みと言えます。",
    },
    {
      question: "社会保険料負担率は2035年にどうなりますか？",
      answer: "1990年10.8%→2025年18.6%のペースが続けば、2030年に約19.8%、2035年に約21.0%まで上昇する可能性が高いです。年収500万円の人は、毎月の手取りが追加で5,000円〜1万円減る計算になります。",
    },
    {
      question: "今後10年で実質賃金は1990年水準に戻りますか？",
      answer: "2025年の春闘で平均賃上げ率5.25%が33年ぶり高水準となりましたが、実質賃金は99.2→97.9へ再低下しました。物価上昇が賃上げを上回る構造が続くと、楽観シナリオでも実質賃金100超えは2028〜2030年頃、悲観シナリオでは2030年代も96前後で推移する可能性があります。",
    },
    {
    ...
    <>
      ...
      >
        <Section heading="次の10年を、データで構想する">
          <p>
            「失われた30年」と呼ばれた1990〜2025年。
            では2026〜2035年の10年間で、日本経済はどう動くのか。
          </p>
          <p>
        ...
        <Section heading="① 出生数：2030年代に60万人割れへ">
          <p>
            最も確度の高い予測は出生数だ。2025年の70.6万人から、社人研の中位推計では2030年に約63万人、2035年に約58万人と見込まれている。
          </p>
          <DataBox
            items={[
              { label: "2025年（実績）", value: "70.6万人", color: "#F59E0B" },
              { label: "2030年（推計）", value: "≒63万人", note: "▲11%", color: "#ef4444" },
              { label: "2035年（推計）", value: "≒58万人", note: "▲18%", color: "#ef4444" },
            ]}
          />
          <p>
        ...
        <Section heading="② 社会保険料負担率：20%超えへ">
          <p>
            ...
            <strong>1990年10.8% → 2025年18.6%</strong>のペースが続けば、2035年には20%を超える可能性が高い。
          </p>
          <DataBox
            items={[
              { label: "2025年（実績）", value: "18.6%", color: "#10B981" },
              { label: "2030年（推計）", value: "≒19.8%", note: "+1.2pt", color: "#ef4444" },
              { label: "2035年（推計）", value: "≒21.0%", note: "+2.4pt", color: "#ef4444" },
            ]}
          />
          <p>
        ...
        <Section heading="③ 国債残高：1,400兆円へ">
          ...
          <DataBox
            items={[
              { label: "2025年度末（実績）", value: "1,128兆円", color: "#06B6D4" },
              { label: "2030年（推計）",     value: "≒1,260兆円", note: "+130兆", color: "#ef4444" },
              { label: "2035年（推計）",     value: "≒1,360兆円", note: "+230兆", color: "#ef4444" },
            ]}
          />
          <p>
        ...
        <Section heading="④ 実質賃金：2028〜2030年の1990年水準回復が鍵">
          <p>
            実質賃金は2024年に99.2まで戻したが、2025年は春闘5%超の高賃上げにもかかわらず97.9へ再低下した。
            物価上昇が賃上げを上回る構造が続いており、1990年水準（100）への本格回復は<strong>2028〜2030年</strong>頃の楽観シナリオに後ろ倒しになっている。
          </p>
          <DataBox
            items={[
        ...
        <Section heading="⑥ CPI：2%目標との戦い">
          <p>
            ...
            2022〜2025年は資源高・円安で年率2〜3%台が続き、CPIは2025年に123.7まで上昇した。
          </p>
          <DataBox
            items={[
              { label: "2025年（実績）",  value: "123.7", note: "1990=100", color: "#D97706" },
              { label: "2030年（中位）",  value: "≒132",  note: "+6.7%",   color: "#D97706" },
              { label: "2035年（中位）",  value: "≒140",  note: "+13.2%",  color: "#D97706" },
            ]}
          />
          <p>
        ...
        <Section heading="⑦ 日経平均：株高は続くか">
          <p>
            2024年に過去最高値を更新した日経平均は、2025年も上昇を続け、約4万9,000円（指数196.1）に到達した。
            企業収益の改善・自社株買いの増加・新NISAによる個人マネー流入が支えている。
          </p>
          <DataBox
            items={[
              { label: "2025年（実績）",  value: "196.1", note: "1990=100",     color: "#8B5CF6" },
              { label: "2030年（楽観）",  value: "≒250",  note: "6万円台",     color: "#22c55e" },
              { label: "2030年（中立）",  value: "≒210",  note: "5.3万円台",   color: "#8B5CF6" },
              { label: "2030年（悲観）",  value: "≒150",  note: "3.8万円割れ", color: "#ef4444" },
            ]}
          />
        </Section>

        <Section heading="⑧ 税収：80兆円台が定着するか">
          <p>
            2025年度に80.7兆円と過去最高を記録した税収は、賃金上昇と物価上昇による所得税・消費税の自然増、株高による金融所得課税の増加で、当面は80兆円台で推移すると見られる。
          </p>
        </Section>

        <Section heading="⑨ 住宅価格：都心と地方の二極化">
          <p>
            首都圏マンションは2025年時点でバブル期超え。日銀の追加利上げで需要が冷え込めば一時的に調整局面に入る可能性もあるが、
        ...
        <Section heading="3つの統合シナリオ">
          <div className="rounded-xl border p-4 space-y-4 my-4" style={{ backgroundColor: "var(--card)", borderColor: "var(--border)" }}>
            <div>
              ...
              <p className="text-xs leading-relaxed" style={{ color: "var(--muted)" }}>
                賃上げの定着・適度な円安維持・株高継続で、実質賃金は2028〜2030年に1990年水準を超える。
        ...
        <Section heading="まとめ">
          ...
          <p>
            KeizaiMap で各指標の35年トレンドを確認し、自分なりの「次の10年」シナリオを描いてほしい。
          </p>
        </Section>
