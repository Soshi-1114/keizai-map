  ...
  return (
    ...
    >
      ...
      <nav aria-label="サイト内ナビゲーション" className="flex items-center gap-2 md:gap-3 shrink-0">
        <Link
          href="/articles"
          className="rounded-full border px-3 py-1.5 text-xs md:text-sm font-medium hover:border-[var(--link)] hover:text-[var(--link)] transition-colors focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600"
